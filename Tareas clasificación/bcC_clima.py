...
class Veg(Atributos):
       def __init__(self, defecto = None, booleano = False):
        nombre='Vegetacion'
        atrib = 'Vegetacion'
        valores=['selva','sabana','escasa','bosque mediterraneo','bosque atlantico','bosque boreal o taiga','tundra','escalonada']
        Atributos.__init__(self, nombre, atrib, defecto, booleano, valores)
...
class Vegetacion(Caracteristica):
    def __init__(self,valor=None):
        nombre='vegetacion'
        valoresPermitidos=['selva','sabana','escasa','bosque mediterraneo','bosque atlantico','bosque boreal o taiga','tundra','escalonada']
        Caracteristica.__init__(self,nombre,valoresPermitidos,valor)
        self.valor=valor
