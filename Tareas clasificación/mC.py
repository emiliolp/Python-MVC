...
class MetodoPoda():
    ...
    def execute(self):
        ...
        for i in range(lpropi):
            ...
            #for clase in self.diferencial:
                #print j
                print "Comprueba"
                print self.valor
                print "en"
                
                print self.diferencial[j].nombre
...
if __name__ == '__main__':
    ...
    if True:
        frio=bcC.Temperatura('alta')
        plantas=bcC.Precipitaciones('alternantes')
        vegeta=bcC.Vegetacion('sabana')
        mp=MetodoPoda([frio,plantas,vegeta])
        mp.execute()
